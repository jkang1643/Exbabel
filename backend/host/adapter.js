...
export async function handleHostConnection(clientWs, sessionId) {
  ...
  const sendWithSequence = (messageData, isPartial = true) => {
    ...
    const { message, seqId } = timelineTracker.createSequencedMessage(dataWithLang, isPartial);
          ...
          if (!speechStream) {
            try {
              ...
              const broadcastWithSequence = (messageData, isPartial = true, targetLang = null) => {
                ...
                // Inject targetLang from state if missing
                const payloadToSend = {
                  ...messageData,
                  targetLang: messageData.targetLang || targetLang || currentTargetLang
                };
                ...
                const tl = payloadToSend?.targetLang;
