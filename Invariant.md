...
10. If a segment is marked finalized in FinalityGate, a FINAL event for that segment must have been emitted (or will be emitted synchronously in the same call).
